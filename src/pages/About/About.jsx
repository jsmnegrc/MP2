      ...
      <Container className="my-5">
        <Row>
          <Col lg={6}>
            ...
            <p>
              Welcome to [Your Company Name], your trusted partner in finding
              the perfect real estate solutions. We are dedicated to helping you
              achieve your dreams of homeownership, whether you're looking to
